...
const wave2 = {
  hi: {
    consentBanner: {
      ...
      body: 'Strong Vault आपके सभी दस्तावेज़ों को <device>आपके डिवाइस पर एन्क्रिप्टेड</device> रूप में संग्रहीत करता है। AI दस्तावेज़ स्कैन के दौरान OCR टेक्स्ट प्रसंस्करण हेतु Anthropic को भेजा जाता है। एनालिटिक्स हमें ऐप सुधारने में मदद करता है। आप सेटिंग्स में कभी भी बदल सकते हैं।',
  ...
  kn: {
    consentBanner: {
      ...
      body: 'Strong Vault ನಿಮ್ಮ ಎಲ್ಲಾ ದಾಖಲೆಗಳನ್ನು <device>ನಿಮ್ಮ ಸಾಧನದಲ್ಲಿ ಗೂಢಲಿಪೀಕೃತ</device>ವಾಗಿ ಸಂಗ್ರಹಿಸುತ್ತದೆ। AI ದಾಖಲೆ ಸ್ಕ್ಯಾನ್ ಬಳಸುವಾಗ OCR ಪಠ್ಯವನ್ನು Anthropic ಗೆ ಕಳುಹಿಸಲಾಗುತ್ತದೆ। ಅನಾಲಿಟಿಕ್ಸ್ ಅಪ್ಲಿಕೇಶನ್ ಸುಧಾರಣೆಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ। ಸೆಟ್ಟಿಂಗ್‌ಗಳಲ್ಲಿ ಯಾವಾಗಲೂ ಬದಲಾಯಿಸಿ।',
  ...
  ta: {
    consentBanner: {
      ...
      body: 'Strong Vault உங்கள் எல்லா ஆவணங்களையும் <device>உங்கள் சாதனத்தில் மறையீடு</device> செய்யப்பட்டு சேமிக்கிறது। AI ஸ்கேன் பயன்பாட்டின்போது OCR உரை Anthropic க்கு அனுப்பப்படுகிறது। Analytics செயலியை மேம்படுத்த உதவுகிறது। அமைப்புகளில் எப்போதும் மாற்றலாம்।',
  ...
  te: {
    consentBanner: {
      ...
      body: 'Strong Vault మీ అన్ని డాక్యుమెంట్లను <device>మీ పరికరంలో ఎన్‌క్రిప్ట్</device> చేసి నిల్వ చేస్తుంది। AI స్కాన్‌లో OCR వచనం Anthropic కు పంపబడుతుంది। సెట్టింగ్‌లలో ఎప్పుడైనా మార్చండి।',
  ...
  ml: {
    consentBanner: {
      ...
      body: 'Strong Vault നിങ്ങളുടെ എല്ലാ രേഖകളും <device>നിങ്ങളുടെ ഉപകരണത്തിൽ എൻക്രിപ്റ്റ്</device> ചെയ്ത് സൂക്ഷിക്കുന്നു। AI സ്കാനിൽ OCR വാചകം Anthropic ലേക്ക് അയയ്ക്കുന്നു। ക്രമീകരണങ്ങളിൽ എപ്പോഴും മാറ്റാം।',
