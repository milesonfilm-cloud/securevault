  ...
  return (
    <div className="p-4 lg:p-6 max-w-screen-2xl mx-auto bg-vault-bg min-h-full">
      ...
      <div className="flex items-start justify-between mb-6 gap-4">
        ...
        <div className="w-10 h-10 rounded-full bg-vault-elevated text-vault-warm flex items-center justify-center flex-shrink-0 border border-[rgba(255,255,255,0.07)]">
          <Settings size={18} />
        </div>
      </div>
      {/* Privacy notice */}
      <div className="neo-card rounded-2xl px-5 py-4 mb-6 flex items-start gap-3">
        <div className="w-9 h-9 bg-[rgba(49,44,81,0.35)] border border-[rgba(255,255,255,0.07)] rounded-2xl flex items-center justify-center flex-shrink-0 mt-0.5">
          <svg
            width="16"
            height="16"
            viewBox="0 0 24 24"
        ...
        <div>
          <p className="text-sm font-800 text-white">100% Private — Zero Cloud Storage</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <div className="space-y-5 lg:col-span-2 xl:col-span-1">
          ...
          <div className="neo-card rounded-2xl p-6">
            <h3 className="text-sm font-800 text-white mb-3">About SecureVault</h3>
            <div className="space-y-2">
              {[
                ...
                <div
                  ...
                  className="flex justify-between items-center py-1.5 border-b border-[rgba(255,255,255,0.07)] last:border-0"
                >
