        ...
        <div className="space-y-2">
          {history.map((record) => (
            <div
              ...
              className="flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors"
            >
              <div className="flex items-center gap-2.5">
                {record.format === 'JSON' ? (
                  <FileJson size={16} className="text-indigo-400 flex-shrink-0" />
                ) : (
