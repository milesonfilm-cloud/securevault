    ...
    reader.onload = (e) => {
      try {
        ...
        const normalized = normalizeVaultData({
          ...
          shareLinks: raw.shareLinks || [],
          emergencyContact: raw.emergencyContact ?? null,
          settings: raw.settings,
          streakData: raw.streakData,
        });
        setParsedData({
  ...
  const handleImport = async () => {
    ...
    try {
      if (mergeMode === 'merge') {
        ...
        const merged: VaultData = normalizeVaultData({
          ...existing,
        ...
        const replaced: VaultData = normalizeVaultData({
          ...parsedData.data,
